...
void main() {
  ...
  testWidgets("test One Select GroupController single selection", (tester) async {
    GroupController controller = GroupController();
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: SimpleGroupedCheckbox<int>(
  ...
  testWidgets("test One Select GroupController multiple selection", (tester) async {
    GroupController controller = GroupController(
      isMultipleSelection: true
    );
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets("test deselect some values in multiple selection  SimpleGroupedCheckbox",
          (tester) async {
        GroupController controller =
        GroupController(isMultipleSelection: true, initSelectedItem: [1, 2]);
        final values = List.generate(10, (index) => index);
